...
const MenTesters = () => {
  ...
  const getPageData=(pageNum,dateSort=false,rateSort=false,priceDec=false,priceAce=false)=>{
       ...
       dispatch(getPerfumes(pageNum,itemsPerPage,dateSort,ActionTypes.ADD_CARD_INFO,true,"Male",rateSort,priceAce,priceDec))
  }
  ...
  return (
    <>
    <LongList itemsPerPage={itemsPerPage} getPageData={getPageData} pageCount={pageCount} shopItems={cardsInfo.cards} title="تستر مردانه"  />

    </>
  )
}

export default MenTesters
